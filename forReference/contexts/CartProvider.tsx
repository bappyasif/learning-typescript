...
const reducer = (state: CartStateType, action: ReducerAction): CartStateType => {
    switch (action.type) {
        case REDUCER_ACTION_TYPE.ADD: {
            ...
            return {
                ...state, cart: [...filteredCart, { sku, name, price, quantity }]
            }
        }
        ...
        case REDUCER_ACTION_TYPE.QUANTITY: {
            ...
            return {
                ...state, cart: [...filteredCart, updatedItem]
            }
...
const useCartContext = (initCartState: CartStateType) => {
    ...
    const totalPrice: string = new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(state.cart.reduce((previousValue, cartItem) => {
    ...
    return {
        dispatch, REDUCER_ACTIONS, totalItems, totalPrice, cart
    }
}
